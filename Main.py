...
class blood_bank:
 def __init__(self):
   ...
   self.Button3.configure(background="#d9d9d9", text="Login", font=("Courier", 35), width=400, command=page)
   self.Button4 = Button(self.Frame1)
   self.Button4.place(relx=0.65, rely=0.49, height=103, width=400)
   self.Button4.configure(background="#d9d9d9",text="Register",font=("Courier", 35),width=400,command=register)
